...
import AcceptOrDeclineButtons from "../components/AcceptOrDeclineButtons";
import MarkAsCompleteButton from "../components/MarkAsCompleteButton";

const RequesterPendingOfferDetails = () => {
          ...
          <>
            ...
            <div className="listContainer">
              ...
              {itemDetails?.status === 1 ? (
                <AcceptOrDeclineButtons id={itemDetails?.id} />
              ) : (
...
export default RequesterPendingOfferDetails;
