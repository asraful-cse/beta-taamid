        ...
        {itemDetails &&
          <>
            ...
            <div className='listContainer'>
              ...
              <hr />
              <OfferedPOItem poItem={itemDetails?.po?.po_item_list} offerItem={itemDetails?.offer_details} />

              <div className='p-2 bg-white border rounded-lg mx-4 mb-4' style={{ borderColor: '#E6E8EC' }}>
