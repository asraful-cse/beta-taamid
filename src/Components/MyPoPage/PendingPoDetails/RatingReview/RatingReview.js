...
const RatingReview = () => {
    ...
    return (
        <div className={` ${pathname === `/reviews`} ? 'pendingItemBoxCard' : ''`}>
            {pathname === `/reviews` ? null : (
                <p className='reviewTitle' style={{ color: ' #23262F', marginLeft: '0!important' }}>
                    My Review & Rating
                </p>
            )}
                        ...
                        <div className='d-flex'>
                            ...
                            <div>
                                <div className='d-flex'>
                                    <p
                                        className='cardTitle'
                                        style={{ color: ' #23262F', marginRight: '0px!important' }}>
                                        DRM Co.
                                    </p>

                                    {pathname === `/reviews` ? null : pathname === `/checking` ? null : (
                                        <p
